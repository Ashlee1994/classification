...
from args_dec14 import Train_Args
    ...
    with tf.Session() as sess:
        ...
        for e in range(args.num_epochs):
            ...
            for i in range(num_batch):
                ...
                loss,accuracy,_= sess.run([deepem.loss, deepem.accuracy, deepem.optimizer], {deepem.X:batch_x, deepem.Y: batch_y})
                acc_train.append(accuracy)
                if i % 10 == 0:
                    print('loss: %.6f  acc: %.6f'% (loss, accuracy),flush=True)
