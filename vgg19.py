...
class Vgg19:
    ...
    def variables_deepem(self):
        ...
        self.data_dict = {
            ...
            'conv1_1': {'filter': [21,21,1,  64],  'biases': [64]},
            'conv1_2': {'filter': [21,21,64, 64],  'biases': [64]},
            'conv2_1': {'filter': [11,11,64, 128], 'biases':[128]},
            'conv2_2': {'filter': [11,11,128,128], 'biases':[128]},
            ...
            'fc8': {'filter': [4096,    self.args.n_classes], 'biases':[self.args.n_classes]}   # 1
        }
